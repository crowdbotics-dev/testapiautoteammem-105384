...
## Project Structure
    ...
    ├── testapiautoteammem_105384  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_105384`
...
2. Clone this repo and `cd testapiautoteammem_105384`
